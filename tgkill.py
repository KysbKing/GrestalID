...
ascii_banner = pyfiglet.figlet_format("TGKill")
...
def complaint():
	...
	print(colored("[1] Виртуальный номер", "blue"))
	print(colored("[2] Премиум","blue"))
	print(colored("[3] Оскорбление","blue"))
	print(colored("[4] Нарушение правил", "blue"))
	print(colored("[5] Сессий", "blue"))
	print(colored("[6] Спам", "blue"))
	print(colored("[7] Прайс", "blue"))
	print(colored("[8] Накрутка", "blue"))
